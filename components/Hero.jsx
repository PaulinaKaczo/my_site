        ...
        <section id="hero" className="hero_container">
            ...
            <div className="text_box">
                ...
                <div className="social_media_wrapper">
                    <span>
                        <a href="https://github.com/PaulinaKaczo" title="github profile" target="_blank" rel="noreferrer">
                            <FontAwesomeIcon icon={faGithub} />
                        </a>
                    </span>
                    <span>
                        <a href="https://www.linkedin.com/in/paulina-kaczorowska-b246801a1/" title="linkedin profile" target="_blank" rel="noreferrer">
